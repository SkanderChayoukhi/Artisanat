...
export class CartComponent implements OnInit {
  products: Product[] = [
    ...
    { name: 'Product 2', price: 20, imageUrl: '../../assets/images/1.jpg' },
    { name: 'Product 3', price: 30, imageUrl: '../../assets/images/1.jpg' },
    ...
    { name: 'Product 5', price: 20, imageUrl: '../../assets/images/1.jpg' },
    { name: 'Product 6', price: 30, imageUrl: '../../assets/images/1.jpg' },
    { name: 'Product 7', price: 20, imageUrl: '../../assets/images/1.jpg' },
    { name: 'Product 8', price: 30, imageUrl: '../../assets/images/1.jpg' },
    ...
    { name: 'Product 10', price: 20, imageUrl: '../../assets/images/1.jpg' }
  ];
